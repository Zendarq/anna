/**
 * Created by slouie on 4/24/2016.
 */
(function($){
    ...
    $.fn.kenburns = function(options) {
        ...
        function update() {
            ...
            // Stop the system right here
            if (top_frame == images.length) {
                endslideshow();
                return;
            }
            ...
            var preload_image = getIndex(top_frame + 1);
        ...
        function endslideshow() {
            ...
            if (options.slideshow_end_callback) {
                options.slideshow_end_callback($canvas, ctx);
            }
        }
        ...
        get_image_info(0, function(){
            get_image_info(1, function(){
                start_time = get_time();
                intervalId = setInterval(update, frame_time);
            })
        });
